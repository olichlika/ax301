...
vlog -vlog01compat -work work +incdir+E:/ax301/ov7670/module {E:/ax301/ov7670/module/sccb_func_module.v}

vlog -vlog01compat -work work +incdir+E:/ax301/ov7670/project/../simulation {E:/ax301/ov7670/project/../simulation/sccb_func_module_tb.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  sccb_func_module_tb
